...
class TestProblemListView(ProtectedViewTestMixin, test.TestCase):
    ...
    """
    url = reverse('fa_visuals_problem_list')
    template = 'problem_list'
    model = Problem


class TestFaVisualsCreateView(CourseStaffViewTestMixin, test.TestCase):
    """
    Test adding a problem.
    """
    url = reverse('fa_visuals_create')
    template = 'problem'
    model = Problem
    ...
    def test_create_problem(self):
        ...
        self.assertEqual('a+b', object.regex)
...
class TestFaVisualsUpdateView(CourseStaffViewTestMixin, test.TestCase):
    """
    Test editing a problem with no submissions.
    """
    url = reverse('fa_visuals_update', kwargs={'pk': 1})
...
class TestProblemClearView(CourseStaffViewTestMixin, test.TestCase):
    ...
    """
    url = reverse('fa_visuals_problem_clear', kwargs={'pk': 1})
    successful_redirect_url = reverse('fa_visuals_update', kwargs={'pk': 1})
    template = 'problems_fa_visuals/submission_check_delete.html'
    model = Problem

    def setUp(self):
        self.object = self.model.objects.create(pk=1, name='test', description='test_problem', regex='a+b')
        CourseStaffViewTestMixin.setUp(self)
...
class TestProblemDeleteView(CourseStaffViewTestMixin, test.TestCase):
    ...
    """
    url = reverse('fa_visuals_delete', kwargs={'pk': 1})
    successful_redirect_url = reverse('fa_visuals_list')
    template = 'problems_fa_visuals/problem_check_delete.html'
    model = Problem
