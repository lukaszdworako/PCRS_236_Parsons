...
from rapt.tests.grammars.grammar_test_case import GrammarTestCase
...
class TestThetaJoin(GrammarTestCase):
    ...
    def test_simple(self):
        ...
        expected = [[['zeppelin'], '\\join', ['year', '<', '1975'], ['floyd']]]
        actual = self.parse(expression)
        self.assertEqual(expected, actual)
    ...
    def test_multiple(self):
        ...
        expected = [
            [['zeppelin'], '\\join', ['year', '<', '1975'], ['floyd'],
             '\\join', ['year', '<', '1960'], ['doors']]
        ]
        actual = self.parse(expression)
        self.assertEqual(expected, actual)
