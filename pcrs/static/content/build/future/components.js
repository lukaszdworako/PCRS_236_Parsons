...
var ProblemMixin = {
    isProblemAttempted: function (problem) {
        ...
        var pID = problem.pk;
        return (data.scores.hasOwnProperty(pType) && data.scores[pType].hasOwnProperty(pID));
    },
...
var ProblemStatusIndicator = React.createClass({displayName: 'ProblemStatusIndicator',
    ...
    render: function () {
        var problemClasses = React.addons.classSet({
            ...
            "pr                                                            oblem-attempted": this.state.attempted && !this.state.completed,
...
var SubmitButton = React.createClass({displayName: 'SubmitButton',
    render: function () {
        return (React.DOM.button({ref: "submitButton", className: "green-button", onClick: this.props.onClick}, "Submit"));
    }}
);