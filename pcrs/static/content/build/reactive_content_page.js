...
/*
 * This is ununsed since we're using the page navigation
 */
    ...
    render: function () {
        ...
        return (
                React.DOM.ul({className: "pcrs-sidenav"},
                    React.DOM.a({className: "side-bar-arrow", href: data.prev_url}, React.DOM.span({className: prevClass})),
                    // items,
                    React.DOM.a({className: "side-bar-arrow", href: data.next_url}, React.DOM.span({className: nextClass}))
                )
            );
    }
});
...
$(function() {
    ...
    $.ajax({
        ...
        success: function (problemData) {
            ...
            // Unused, since we're using the page view
            // React.renderComponent(
