...
function add_to_history(score){
    ...
    new_entry += '<a data-toggle="collapse" data-parent="#accordion" href="#collapse_999" onclick="delay_refresh_cm()">'
    new_entry += datetime + '<td> Score :' + score +'/'+ testcases.length + '</td></a></h4></div>'
    new_entry += '<div id="collapse_999" class="panel-collapse collapse">'
    new_entry += '<div id="history_mirror_999_999">' + myCodeMirror.getValue() + '</div>'
    ...
    create_history_code_mirror ('python', 3, 'history_mirror_999_999');
}
