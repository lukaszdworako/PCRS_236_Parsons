...
function update_debugger_table(data){if(data[debugger_index].length){$('#debugger_table').empty();myCodeMirrors[debugger_id].removeLineClass(last_stepped_line_debugger,'','CodeMirror-activeline-background');}
