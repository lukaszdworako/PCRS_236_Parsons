...
return false;}
function createVisualizer(data,newCode){debugger_data=data;if(!c_debugger_load){c_debugger_load=true;$('#visualizerModal').on('shown.bs.modal',function(){myCodeMirrors[debugger_id].refresh();});$('#previous_debugger').bind('click',function(){if(debugger_index>=1){debugger_index--;}
