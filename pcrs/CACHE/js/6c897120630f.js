...
function createVisualizer(data,newCode){myCodeMirrors[debugger_id].setValue(newCode);$('#visualizerModal').on('shown.bs.modal',function(){myCodeMirrors[debugger_id].refresh();});update_debugger_table(data);$('#visualizerModal').modal('show');$('#previous_debugger').bind('click',{data:data},function(){update_debugger_table(data);if(debugger_index>=1){debugger_index--;}});$('#next_debugger').bind('click',{data:data},function(){update_debugger_table(data);if(debugger_index>=1){debugger_index++;}});$('#reset_debugger').bind('click',{data:data},function(){debugger_index=1;update_debugger_table(data);});}
