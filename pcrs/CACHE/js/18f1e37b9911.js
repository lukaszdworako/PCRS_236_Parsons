...
function addHashkey(){var line_count=myCodeMirrors[div_id].lineCount();var code=" ";var wrapClass;var i;for(i=0;i<line_count;i++){wrapClass=myCodeMirrors[div_id].lineInfo(i).wrapClass;if(wrapClass=='CodeMirror-studentline-background')
...
function getTestcases(div_id){var clean_code;if(language=='c'){clean_code=addHashkey();}else{clean_code=myCodeMirrors[div_id].getValue();}
