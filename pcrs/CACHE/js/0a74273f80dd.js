...
function createVisualizer(data){console.log(data);myCodeMirrors[debugger_id].setValue(data['source_code']);$('#visualizerModal').on('shown.bs.modal',function(){myCodeMirrors[debugger_id].refresh();});$('#visualizerModal').modal('show');}
