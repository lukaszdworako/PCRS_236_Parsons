...
function createVisualizer(data){console.log(data);cmh_list[debugger_id].setValue(data['source_code']);$('#visualizerModal').on('shown.bs.modal',function(){cmh_list[debugger_id].refresh();});$('#visualizerModal').modal('show');}
