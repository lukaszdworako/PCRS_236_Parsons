...
update_debugger_table(data);});$('#next_debugger').bind('click',{data:data},function(){if(data[debugger_index].length!=undefined){debugger_index++;update_debugger_table(data);}});$('#reset_debugger').bind('click',{data:data},function(){debugger_index=0;update_debugger_table(data);});}
