...
function createVisualizer(data,newCode){myCodeMirrors[debugger_id].setValue(newCode);$('#visualizerModal').on('shown.bs.modal',function(){myCodeMirrors[debugger_id].refresh();});$('#previous_debugger').bind('click',function(data){$('#debugger_table').append("<tr>");$('#debugger_table').append('<th class="text-nowrap" scope="row">Grid behavior</th>');$('#debugger_table').append("<td>Horizontal at all times</td>");$('#debugger_table').append("<td>Collapsed to start, horizontal above breakpoints</td>");$('#debugger_table').append("<td>teste</td>");$('#debugger_table').append("<td></td>");$('#debugger_table').append("</tr>");});$('#next_debugger').bind('click',function(data){});$('#reset_debugger').bind('click',function(data){});$('#visualizerModal').modal('show');}
