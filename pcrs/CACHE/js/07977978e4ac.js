...
function errorsInTraceC(data){if(data.hasOwnProperty('exception')){alert(data['exception']);var find="<br />";var re=new RegExp(find,'\n');str=str.replace(re,'');alert(data['exception']);}
